...
def Decrypt():
    ...
    P = []
    C = str(raw_input("Enter ciphertext blocks:"))
    C = C.lstrip('[')
    C = C.rstrip(']')   
    C = C.split(',')
    for i in range(len(C)):
...
while mm != 'quit':
	...
	print time.time() - start_time , "seconds"
        ...
        if mm != 'quit':
            ...
            statements = ["I sorry, Kelvin.. I'm afraid i can't do that","I'm begging you....read the directions","Nah ahh ahh, didnt say the magic word","This input is....UNACCEPTABLE!!","Seriously....was that even a word???","Please follow the directions","Just type 'help' if you are really that lost"]
            print(statements[ii])
